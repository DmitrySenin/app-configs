...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode json-mode popup-kill-ring htmlize spaceline rainbow-delimiters switch-window rainbow-mode avy smex beacon org-bullets spacemacs-theme which-key use-package))))
(custom-set-faces
